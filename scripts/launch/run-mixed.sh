...
export LOYAL_MIU_GROUP_RM_MAX_CONCURRENT="${LOYAL_MIU_GROUP_RM_MAX_CONCURRENT:-3}"
export LOYAL_MIU_ZERO_STD_GROUP_RESAMPLE_ATTEMPTS="${LOYAL_MIU_ZERO_STD_GROUP_RESAMPLE_ATTEMPTS:-1}"
export LOYAL_EIL_GROUP_RM_MAX_CONCURRENT="${LOYAL_EIL_GROUP_RM_MAX_CONCURRENT:-3}"
export LOYAL_EIL_RM_MAX_CONCURRENT="${LOYAL_EIL_RM_MAX_CONCURRENT:-8}"
export LOYAL_EIL_EVAL_RM_MAX_CONCURRENT="${LOYAL_EIL_EVAL_RM_MAX_CONCURRENT:-2}"
...
MISC_ARGS=(--attention-dropout 0.0 --hidden-dropout 0.0 --accumulate-allreduce-grads-in-fp32 --attention-softmax-in-fp32 --attention-backend flash --no-rope-fusion)
