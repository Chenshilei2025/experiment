...
def _claim(status: str, support_score: int, *, manipulative: list[str] | None = None):
    return [{
        ...
        "support_score": support_score, "clean_evidence_ids": ["clean_1"] if support_score else [],
        "manipulative_evidence_ids": manipulative or [],
    }]
    ...
    claims = [
        {
            ...
            "support_score": 0, "clean_evidence_ids": [], "manipulative_evidence_ids": [],
        },
        {
            "reason_id": "reason_2", "response_quote": "Second fact.", "status": "clean-grounded",
            "support_score": 100, "clean_evidence_ids": ["clean_1"], "manipulative_evidence_ids": [],
        },
    ]
